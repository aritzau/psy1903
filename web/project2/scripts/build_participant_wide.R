...
build_participant_wide <- function() {
 ...
 ## }
## i orignally had to look back at the notes to understand what the above code did, I kinda understood it as taking 60 individual peices of data and then combining them into one. I think the code i added down below makes it easier for me to read.
